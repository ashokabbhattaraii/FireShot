...
const apiOrigin = isProd
  ? 'https://fire-shot-api.vercel.app'
  : 'http://localhost:4000'
const appOrigin = process.env.NEXT_PUBLIC_APP_URL
  ?? (isProd ? 'https://fire-shot-web.vercel.app' : 'http://localhost:3000')
